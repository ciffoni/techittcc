...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Set-2023 às 19:28
...
CREATE TABLE `produto` (
  ...
  `datav` date NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `produto` (`idproduto`, `nome`, `valor`, `foto`, `valida`, `datav`) VALUES
(1, 'coca', '7.50', 'C:\\Users\\aluno\\Documents\\GitHub\\techittcc\\foto\\coca.jpg', 0, '2023-09-16'),
(2, 'coxinha', '7.50', 'C:\\Users\\aluno\\Pictures\\coxinha.png', 1, '2023-09-19');
...
(1, 'jorge ciffoni', 'ciffoni', '8331e766a06eedd77bdc3afb4bdc4ad7', 2),
